...
const CharactersPage = () => {
  ...
  return (
    <div className='container py-3 items-center '>
      {loading ? (
        <Loading /> // Render Loading component if characters are still loading
      ) : (
        <div className='w-full text-center'>
          {/* ============ Filtros ============ */}
          <div className='w-full flex flex-col md:flex-row gap-10 items-center justify-center mb-2'>
            <label className='p-2 flex'>
              Filter by eye color:
              <select
                className='block w-full border-2 border-yellow-300 bg-black rounded-md py-2 w-full px-3 focus:outline-none focus:border-yellow-600'
          ...
          {/* ============ Personajes ============ */}
          <div className='gap-4 grid md:flex flex-wrap lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 items-center justify-center'>
            {currentCharacters.length === 0 ? (
              ...
              currentCharacters.map((character, index) => (
                <div
                  key={index}
                  className='flex items-center justify-center bg-gray-800 rounded-lg p-5 shadow-md border-2 border-transparent hover:border-yellow-500  bg-opacity-75'>
                  <div className='flex flex-col items-center justify-between md:w-[200px] md:h-[250px]'>
